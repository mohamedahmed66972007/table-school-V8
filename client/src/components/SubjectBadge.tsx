...
const subjectColors: Record<Subject, string> = {
  ...
  "إسلامية وقرآن": "bg-amber-500/20 text-amber-300 border-amber-500/30",
  "اجتماعيات": "bg-pink-500/20 text-pink-300 border-pink-500/30",
  "جيولوجيا": "bg-yellow-500/20 text-yellow-300 border-yellow-500/30",
  "دستور": "bg-indigo-500/20 text-indigo-300 border-indigo-500/30",
};
